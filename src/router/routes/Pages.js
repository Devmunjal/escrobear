...
const PagesRoutes = [
  ...
  },
  {
    ...
    component : lazy(() => import('../../views/pages/authentication/Kyc1')),
    layout:'BlankLayout'
  },
  {
    path : "/kyc-address-proof",
    component :lazy(() => import('../../views/pages/authentication/Kyc2')),
    layout:'BlankLayout'
  },
  {
    path:"/verify-email",
    component : lazy(() => import('../../views/pages/authentication/VerifyEmail')),
    layout:'BlankLayout',
    meta:{
      authRoute:true
    }
