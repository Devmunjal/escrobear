...
import { Facebook, Twitter, Mail, GitHub, Edit } from 'react-feather'
...
const Kyc2 = (props) => {
  ...
  function uploadDocument() {
    ...
    }).then(resp => resp.json()).then(resp => { props.setstep("3") })
  }
  // const RememberMe = () => {
  //   return (
  //     <Fragment>
            ...
            <Form className='auth-register-form mt-2' onSubmit={e => e.preventDefault()}>
              <FormGroup>
                ...
                <ButtonDropdown isOpen={dropdownOpen} toggle={toggleDropdown} style={{width:"100%", marginBottom:"10px"}}>
                  ...
                  <DropdownMenu>
                    <DropdownItem onClick={(e) => { setoptionSelected(e.target.outerText); setdisabledUpload(true) }} tag='a'>Option 1</DropdownItem>
