...
const Register = () => {
  ...
  const handleSubmit = (event, errors) => {
    ...
    }).then(resp => resp.json()).then(resp => { window.location.pathname = "/verify-email" })
  }
  ...
  const handlecountryChange = e => {
    const errs = errors
    if (errs.country) delete errs.country
            ...
            <Row>
              ...
              <FormGroup>
                ...
                <AvInput
                  ...
                  className={classnames({ 'border-danger': Object.keys(errors).length && errors.Firstname })}
                />
              ...
              <FormGroup>
                ...
                <AvInput
                  ...
                  className={classnames({ 'border-danger': Object.keys(errors).length && errors.Lastname })}
                />
              ...
              <FormGroup>
                ...
                <AvInput
                  ...
                  className={classnames({ 'border-danger': Object.keys(errors).length && errors.country })}
                />
                {Object.keys(errors).length && errors.country ? (
              ...
              <Button.Ripple
                block
                color='primary'
                disabled={!email.length || !password.length || !Firstname.length || !Lastname || !country || !terms || password !== Confirmpassword}
              >
                Sign up
              </Button.Ripple>
            </AvForm>
