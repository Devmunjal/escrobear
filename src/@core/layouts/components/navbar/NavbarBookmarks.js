  ...
  return (
    <Fragment>
      ...
      <ul className='nav navbar-nav bookmark-icons'>
        <Button  className='nav-item d-none d-lg-block' color ="success">Create Escrow</Button>
        <Button  className='nav-item d-none d-lg-block' style={{marginLeft:"10px"}} color ="primary"> Accept Escrow</Button>
      </ul>
      {/* <ul className='nav navbar-nav bookmark-icons'>
        {renderBookmarks()}
