...
import { Navbar, Button, UncontrolledButtonDropdown, DropdownMenu, DropdownItem, DropdownToggle } from 'reactstrap'
...
const VerticalLayout = props => {
  ...
  return (
    <div>
     <div className="card" style={{position:"fixed", width:"100%", top:"0px", padding:"10px", zIndex:"999", marginBottom:"0px", textAlign:`${window.screen.width >= 900 ?  "left" : "right"}`}}>
        <Row>
          {window.screen.width > 900 && <Col >
            Global MarketCap....
          </Col> }
          {window.screen.width > 900 && <Col>
            BTC Dominance ...
    ...
    >
      ...
      <div className="card">
      <Navbar
      style={{boxShadow:"0px 0px 20px lightgrey"}}
        expand='lg'
        light={skin !== 'dark'}
